"""Structural and tone checks: passive voice, step structure, fear/shouting, reassurance, sentence length."""
...
# words that tend to cause panic rather than guide action
_FEAR_WORDS = {
...
# phrases that reassure the reader or point them to help
...
# action verbs that suggest the text is giving instructions
_ACTION_VERBS = {
...
LONG_SENTENCE_WORDS = 22  # above this, comprehension drops for many readers
